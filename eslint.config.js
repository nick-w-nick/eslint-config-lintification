...
// Set up FlatCompat for configs that don't use the new flat config style
...
export default [
    ...
    {   // Rules for JavaScript files, that TypeScript should inherit
        files: [
            '**/*.js',
            '**/*.ts',
        ],
        ...
        rules: {
            ...
            '@stylistic/quote-props': 'off',                // Allow quote style to be inconsistent (enforced by another rule)
        ...
        languageOptions: {
            ...
            parserOptions: {
                project: [
                    ...
                    path.resolve('tests/tsconfig.json'),
                ],
            },
        },
        rules: {
    ...
    // ...compat.extends('jest/recommended'),
];
